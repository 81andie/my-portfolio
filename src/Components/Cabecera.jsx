...
export const Cabecera = () => {
    ...
    const imageData = [
        [
            ...
            { src: "img/cleopatraCosmetics.jpg", title: "Cleopatra Cosmétics", heightClass: "h-52", id: 3 }
        ],
        [
        ...
        [
            ...
            { src: "imgProjects/angBitacora1.jpg", title: "Bitácora Map", heightClass: "h-44", id: 9 },
           
        ],
        [
            { src: "img/mockuptrafic.png", title: "Traffic Valencia", heightClass: "h-auto", id: 1 },
            { src: "img/Mobile App Screen Mockup, Mosaic.png", title: "The Holy Wine", heightClass: "h-auto", id: 7 },
            { src: "imgProjects/thunder1.jpg", title: "ThunderAI", heightClass: "h-40", id: 8 }
        ]
    ];

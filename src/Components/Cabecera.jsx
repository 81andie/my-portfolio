...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4 ml-10 mr-10">
    <div class="grid gap-4">
        <figure class="max-w-full relative">
            <img class="h-auto max-w-full rounded-lg bg-zinc-200" src="public/img/iPhone 15 Mockup, Perspective.png" alt=""/>
            <figcaption class="bottom-3 w-full z-90 absolute text-center  text-white font-semibold bg-black/50 px-5 py-2 text-xs">SpairAirTracker</figcaption>
        </figure>
        
        <figure class="max-w-full relative"> 
            <img class="h-auto max-w-full rounded-lg" src="public/img/mockDrop_Thunderbolt display on a table.jpg" alt=""/>
            <figcaption class="bottom-3 w-full z-90 absolute text-center  text-white font-semibold bg-black/50 px-5 py-2 text-xs">Cleopatra Cosmétics</figcaption>
        
        </figure>
        <figure class="max-w-full relative">
            <img class="h-auto max-w-full rounded-lg" src="public/img/mockDrop_Apple Pencil close by (5).jpg" alt=""/>
            <figcaption class="bottom-3 w-full z-90 absolute text-center  text-white font-semibold bg-black/50 px-5 py-2 text-xs">Harry Potter App</figcaption>
        </figure>
    </div>
    <div class="grid gap-4">
        <figure class="max-w-full relative">
            <iframe class="h-52 object-cover max-w-full rounded-lg" src="public/img/macbook-subtle-turn.mp4" allow="autoplay; fullscreen; picture-in-picture" alt=""/>
            <figcaption class="bottom-5 lg:bottom-2 md:bottom-2 w-full z-90 absolute text-center  text-white font-semibold bg-black/50 px-5 py-2 text-xs">Claustrum Aqvae</figcaption>
        </figure>
        <figure class="max-w-full relative">

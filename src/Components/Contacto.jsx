    ...
    <>
      <form className="mb-20 mr-2 ml-2 mt-32">
        <div className="flex flex-col  lg:flex-row md:flex-row">
          ...
          <h2 className="mb-4 text-2xl tracking-tight font-extrabold text-center text-zinc-700 font-mono">Contacto</h2>
          ...
          <textarea id="message" rows="4" className="mt-4  block p-2 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500   dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Que quieres consultarme..."></textarea>
          <button type="submit" className=" bg-zinc-900 text-white p-1 rounded-sm mt-2 w-28 h-10">Enviar</button>
          </div>

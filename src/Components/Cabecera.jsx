...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4 ml-10 mr-10">
    <div class="grid gap-4">
        <figure class="max-w-full relative">
            <img class="h-auto max-w-full rounded-lg opacity-60  hover:opacity-100 transition-opacity duration-300 bg-zinc-200" src="public/img/iPhone 15 Mockup, Perspective.png" alt=""/>
        ...
        <figure class="max-w-full relative"> 
            <img class="h-48 object-cover max-w-full  opacity-40 hover:opacity-100 rounded-lg" src="public/img/mockDrop_Thunderbolt display on a table.jpg" alt=""/>
    ...
    <div class="grid gap-4">
        <figure class="max-w-full relative">
            <iframe class="h-52 object-cover max-w-full rounded-lg  opacity-50  hover:opacity-100 transition-opacity duration-300 " src="public/img/macbook-subtle-turn.mp4" allow="autoplay; fullscreen; picture-in-picture" alt=""/>
        ...
        <figure class="max-w-full relative">
            <img class="h-auto max-w-full rounded-lg bg-zinc-200 opacity-50  hover:opacity-100 transition-opacity duration-300 " src="public/img/Iphone 15 Screens Mockup.png" alt=""/>
        ...
        <figure class="max-w-full relative">
            <img class="h-56 object-cover bg-zinc-200 opacity-40  hover:opacity-100 transition-opacity duration-300 max-w-full rounded-lg" src="public/img/Mobile App Screen Mockup, Mosaic.png" alt=""/>
